---
title: "How to Make a Flat White at Home: Recipe and Milk Technique"
date: 2026-04-04
description: "A flat white recipe for home baristas. Covers the exact espresso-to-milk ratio, microfoam technique, and what makes a flat white different from a latte."
tags: ["flat white", "recipe", "espresso drink", "milk drink", "latte art"]
categories: ["recipes"]
...
| Component | Amount |
|-----------|--------|
| Espresso | 1 double shot (18g in, 36g out) |
| Steamed milk | 4oz (120ml) |
| Foam | Very thin — less than 0.5cm |
| Serving cup | 5-6oz ceramic cup |
...
| Aspect | Flat White | Latte | Cappuccino |
|--------|-----------|-------|------------|
| Espresso | Double shot | Double shot | Double shot |
| Milk volume | 4oz | 8-10oz | 2oz liquid |
| Foam | Very thin (~0.5cm) | Thin (~1cm) | Thick (~2oz, equal to liquid) |
| Total drink size | 5-6oz | 10-12oz | 6oz |
| Espresso intensity | Strong | Mild | Medium (foam changes perception) |
| Serving vessel | Small ceramic cup | Large mug or glass | Wide-brimmed cup |
