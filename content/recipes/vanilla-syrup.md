---
title: "How to Make Vanilla Syrup for Coffee (3 Recipes)"
date: 2026-04-23
description: "Make vanilla syrup for coffee in 5 minutes — vanilla bean, vanilla extract, and brown sugar vanilla recipes. Better than store-bought, stays fresh for 4 weeks."
tags: ["vanilla syrup", "coffee syrup", "homemade syrup", "latte recipe"]
categories: ["recipes"]
author: "Barista At Home"
showToc: true
TocOpen: false
draft: false
recipeYield: "1 cup (about 16 tablespoons)"
prepTime: "PT2M"
totalTime: "PT10M"
...
recipeInstructions:
  ...
  - "Stir until sugar fully dissolves, about 3–4 minutes."
  - "Remove from heat. Add vanilla extract and stir."
  - "Cool completely before transferring to an airtight bottle."
...
2. Stir until the sugar fully dissolves — about 3–4 minutes. Don't let it boil.
3. Remove from heat. Add vanilla extract and stir to combine.
4. Cool completely (about 20 minutes at room temp, or 10 minutes in an ice bath).
5. Pour into a clean glass jar or squeeze bottle. Refrigerate.

**Yield:** ~1 cup (16 tablespoons)
**Standard coffee shop serving:** 1–2 tablespoons per 12 oz drink
...
**Instructions:**
1. Split the vanilla bean and scrape the seeds into the saucepan.
2. Add the pod, sugar, and water. Heat over medium, stirring until dissolved.
3. Once dissolved, reduce to low and steep 5 minutes (do not boil).
4. Remove from heat. Cool, then remove the pod (rinse and dry it — it's still usable for vanilla sugar).
5. Strain through a fine mesh strainer if any pod fragments are present.
6. Bottle and refrigerate.

**Yield:** ~1 cup
**Tip:** Don't throw the spent pod away — bury it in a jar of sugar for homemade vanilla sugar.
...
2. Stir until fully dissolved. The syrup will look darker than white sugar syrup — that's normal.
3. Remove from heat, add vanilla extract, stir.
4. Cool completely and bottle.
...
- **[Vanilla Latte](/recipes/vanilla-latte/)** — The classic. 2 shots espresso + vanilla syrup + steamed milk.
- **[Honey Latte](/recipes/honey-latte/)** — Swap the vanilla syrup for honey syrup; both work as a sweetener base.
- **[Vanilla Sweet Cream Cold Brew](/recipes/vanilla-sweet-cream-cold-brew/)** — Cold brew with vanilla-sweetened heavy cream float.
- **[Vanilla Iced Latte](/recipes/iced-latte/)** — Cold milk + vanilla syrup + espresso over ice.
- **[Cinnamon Dolce Latte](/recipes/cinnamon-dolce-latte/)** — Add a pinch of cinnamon to your vanilla syrup for this seasonal-style drink.
