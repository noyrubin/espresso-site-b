---
title: "How to Make Iced Coffee at Home (4 Methods)"
date: 2026-04-10
description: "Learn how to make iced coffee at home using four different methods: flash brew, cold brew, iced espresso, and Japanese iced coffee. Each method explained with exact ratios."
tags: ["iced coffee", "iced coffee recipe", "how to make iced coffee", "cold coffee", "recipes"]
categories: ["recipes"]
...
draft: false
schema: "recipe"
recipeName: "Iced Coffee (Flash Brew Method)"
recipeCategory: "Coffee"
prepTime: "PT2M"
totalTime: "PT7M"
recipeYield: "1 serving"
recipeIngredient: ["22g ground coffee (medium-coarse grind)", "200ml hot water (93°C / 200°F)", "100g ice cubes (in the brewing vessel)", "Milk or cream to taste (optional)"]
recipeInstructions: ["Grind 22g of coffee to a medium-coarse setting.", "Place 100g of ice directly in your pour-over dripper or pitcher.", "Brew hot water (200ml) slowly over the grounds — the coffee brews directly onto the ice.", "The ice chills the coffee instantly as it brews, preserving bright aromas.", "Pour over a glass of fresh ice. Add milk or sweetener if desired."]
---
...
**How to make it:**
1. Place 100g of ice directly in the vessel you're brewing into (not the serving glass — the brewing vessel).
2. Brew your pour-over or drip coffee with 200ml of hot water over 22g of grounds.
3. As the coffee drips through, it hits the ice and chills immediately.
4. The total water + ice = 300ml liquid — a normal single serving, now iced.
5. Pour over fresh ice in a serving glass. Add milk or cream if desired.
...
**How to make it:**
1. Grind coffee coarsely — coarser than French press. Over-extraction is the main risk with extended steep time.
2. Combine coffee and water in a jar, pitcher, or French press. Stir gently to ensure all grounds are saturated.
3. Cover and refrigerate for 14–18 hours (or up to 24 hours for stronger results).
4. Strain through a fine-mesh strainer lined with a paper coffee filter, or press the French press plunger.
5. The result is a concentrate. Dilute 1:1 with water or milk when serving over ice.
...
For a complete guide to ratios and variations, see [cold brew coffee recipe](/recipes/cold-brew-coffee-recipe/) and [cold brew ratio guide](/guides/cold-brew-ratio/).
...
2. Pull 2 shots of espresso directly over the ice (or pull normally and pour immediately over ice).
3. Add milk. Stir.
4. Optional: Add a splash of simple syrup or vanilla syrup if you prefer sweetness.
...
For more on espresso-based iced drinks, see [iced latte recipe](/recipes/iced-latte/) and [Vietnamese iced coffee](/recipes/vietnamese-iced-coffee/).
...
**How to make it:**
1. Combine cold brew (or espresso), ice, milk, and sweetener in a blender.
2. Blend on high for 30–45 seconds until smooth and no ice chunks remain.
3. Pour into a tall glass. Top with whipped cream if desired.
...
1. **Brew twice as strong:** Use double the coffee grounds with your regular drip machine or French press.
2. **Let it cool:** Brew into a pitcher and let it reach room temperature, then refrigerate. (Or speed this up by placing the pitcher in an ice bath.)
3. **Serve over ice:** Pour the strong coffee over a full glass of ice. The melting ice dilutes the coffee back to normal drinking strength.
...
Not if you want it to taste good. Pouring regular-strength hot coffee over ice dilutes it 30-40% as the ice melts — the result is weak and watery. The solution is to brew stronger (flash brew, cold brew concentrate, or espresso) before adding ice.
...
An iced latte uses espresso as the base and adds milk (usually in a higher ratio). Iced coffee uses brewed coffee (from a drip machine, pour-over, or similar method) and may or may not include milk. Iced lattes are more concentrated and milk-forward; iced coffee is more coffee-forward.

**Can I use regular ground coffee for iced coffee?**
Yes. Use pre-ground medium-roast coffee for drip-style iced coffee. If making cold brew, use a coarser grind specifically — most pre-ground coffee is too fine for cold brew and will over-extract to a bitter result.

**How do you make iced coffee without it getting watered down?**
Three options: (1) Flash-brew directly over ice to compensate with a stronger brew, (2) use coffee ice cubes instead of regular ice (freeze leftover coffee in an ice cube tray), or (3) use less ice and drink it faster before melting dilutes it.
