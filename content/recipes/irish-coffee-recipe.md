---
title: "Irish Coffee Recipe: The Definitive Guide (Classic + Espresso Version)"
date: 2026-04-16
description: "The best Irish coffee recipe — original Joe Sheridan method with Irish whiskey, hot coffee, brown sugar, and a cream float. Plus an espresso version and 5 variations."
tags: ["irish coffee", "coffee cocktail", "whiskey", "hot drinks", "recipes"]
categories: ["recipes"]
...
schema:
  ...
  description: "Traditional Irish coffee with Irish whiskey, hot strong coffee, brown sugar, and a lightly whipped cream float."
  prepTime: "PT3M"
  cookTime: "PT2M"
  totalTime: "PT5M"
  recipeYield: "1 serving"
  recipeIngredient:
    - "6 oz (180ml) freshly brewed hot coffee"
    - "1.5 oz (45ml) Irish whiskey"
    - "2 tsp brown sugar"
    - "2 oz (60ml) heavy cream, lightly whipped"
  recipeInstructions:
    - "Preheat a heatproof glass mug by filling with hot water for 30 seconds. Discard the water."
    - "Add 2 teaspoons of brown sugar to the warm glass."
    - "Pour in 6 oz of hot, strong brewed coffee and stir until sugar dissolves completely."
    - "Add 1.5 oz of Irish whiskey. Stir once to combine."
    - "Float lightly whipped cream over the back of a spoon on top. Do not stir — drink through the cream."
---
...
1. **Preheat the glass** — Fill your glass with hot water and let it sit for 30 seconds, then discard. A warm glass keeps the coffee hot and prevents thermal shock.
2. **Add sugar** — Put 2 teaspoons of brown sugar in the warm glass.
3. **Pour hot coffee** — Add 6 oz of freshly brewed hot, strong coffee. Stir until sugar fully dissolves.
4. **Add whiskey** — Pour in 1.5 oz of Irish whiskey. Stir once gently to incorporate.
5. **Float the cream** — Lightly whip the heavy cream until it barely holds shape (not stiff peaks — it should still be pourable). Pour it slowly over the back of a spoon held just above the coffee surface. The cream should float on top.
6. **Serve immediately** — Do **not** stir. Drink through the cream layer. That contrast is the whole point.
...
Traditional Irish coffee uses **Irish whiskey only** — no Baileys. Baileys was invented in 1974, decades after the original. Baileys Irish coffee is a popular variation that's widely served today, but purists use straight Irish whiskey with plain whipped cream.

**What alcohol is best for Irish coffee?**
**Irish whiskey** — specifically Jameson, Bushmills, or Tullamore D.E.W. The triple-distilled smoothness of Irish whiskey pairs with coffee without overpowering it. Scotch, bourbon, or rye don't work as well in this application.

**Is Irish coffee served hot or cold?**
Traditional Irish coffee is hot. The cream float on hot coffee is what defines the drink. Iced Irish coffee is a modern variation that works well in summer.

**Can you make Irish coffee with espresso?**
Yes — 2 shots of espresso + 4 oz hot water is a popular upgrade that gives cleaner, more intense coffee flavor. The method is the same: dissolve sugar in the hot espresso-water, add whiskey, float cream.

**How do you keep the cream floating?**
The cream must be lightly whipped — not still liquid, not stiff peaks. Pour it slowly over the back of a spoon held just above the coffee surface. The slight fat structure from partial whipping gives it enough density to float.
