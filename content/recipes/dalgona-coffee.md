---
title: "Dalgona Coffee Recipe: The Whipped Korean Coffee Cloud (1:1:1 Ratio + Why Only Instant Coffee Works)"
date: 2026-04-10
description: "Dalgona coffee is whipped instant coffee, sugar, and hot water in equal parts — beaten until it forms a thick caramel-colored cloud and spooned over cold milk. Full recipe, the chemistry of why only instant coffee will whip, and how it compares to Greek frappe and Vietnamese egg coffee."
tags: ["dalgona coffee", "whipped coffee", "viral coffee", "recipes", "iced coffee"]
categories: ["recipes"]
...
draft: false
schema: "recipe"
recipeName: "Dalgona Coffee (Whipped Coffee)"
recipeCategory: "Coffee"
prepTime: "PT5M"
totalTime: "PT5M"
recipeYield: "1 serving"
recipeIngredient: ["2 tablespoons instant coffee", "2 tablespoons granulated sugar", "2 tablespoons hot water (near-boiling)", "1 cup milk (dairy or plant-based)", "Ice (for iced version)"]
recipeInstructions: ["Combine instant coffee, sugar, and hot water in a bowl.", "Whip with a hand mixer, electric beaters, or by hand with a whisk for 3–5 minutes until the mixture is thick, glossy, and holds stiff peaks.", "Fill a glass with ice (or warm milk for a hot version).", "Pour or spoon the whipped coffee on top of the milk.", "Stir before drinking to combine, or enjoy the layered effect first."]
---
...
2. Beat on medium-high speed until thick, glossy, and holds stiff peaks — about 2 minutes.
3. The mixture is ready when it ribbons back slowly when you lift the beaters.

**Whisk by hand (traditional — 5–8 minutes):**
1. Combine all three ingredients in a small bowl or jar.
2. Whisk vigorously in a circular motion. Your arm will get tired — that is normal.
3. After 5–8 minutes, the mixture will start to thicken. Keep going until it holds peaks.
4. The hand-whisk method works but takes real effort.

**Immersion blender (30 seconds):**
1. Combine in a jar or tall cup.
2. Blend on high for 30 seconds until thick.
3. Fastest method; slightly airier result.

**Serve:**
1. Fill a glass with ice (or warm milk for hot dalgona).
2. Pour or pour milk over the ice.
3. Spoon the whipped coffee foam on top.
4. Serve with a straw and spoon — stir before drinking or let it swirl as you sip.
...
**Hot Dalgona Coffee**
Make the whipped foam the same way. Instead of iced milk, heat 1 cup of milk in a saucepan until steaming (150°F). Pour into your mug and spoon the foam on top. The foam is already at room temperature — the hot milk will warm it slightly as you stir.

**Dalgona Matcha (Whipped Matcha)**
A popular adaptation that doesn't use coffee at all, but the same layered aesthetic:
...
**Vanilla Dalgona**
Add 1/4 teaspoon vanilla extract to the base before whipping. The vanilla integrates during whipping and gives the foam a subtle dessert note.

**Brown Sugar Dalgona**
Substitute brown sugar for white sugar. The result has a richer, more molasses-forward flavor and a slightly darker foam color. Works especially well with oat milk.

**Espresso Dalgona (for Home Baristas)**
If you want to avoid instant coffee entirely, you can create a similar visual result by cold-frothing strong brewed espresso with heavy cream:
...
**Decaf Dalgona**
Use decaf instant coffee (Nescafé makes a decaf instant). The foam whips identically. Same visual, same taste, no caffeine.
...
The closest cousin is **Greek frappe** — both use instant coffee, sugar, and aeration — but frappe is *shaken* with cold water and creates a fine bubbly head, while dalgona is *whipped* with hot water and creates a stiff meringue-like cloud. See our [Greek coffee guide](/guides/greek-coffee/) for the full Thessaloniki-1957 frappe story.
...
1. The concentration of surface-active compounds is lower
2. The remaining oils behave differently in liquid form
3. There is no air-trapping matrix equivalent to what forms in instant coffee foam
...
For more on [how to make cold foam](/recipes/cold-foam/) from milk for iced lattes, see our dedicated guide.
...
- [Vietnamese Egg Coffee (Cà Phê Trứng)](/recipes/vietnamese-egg-coffee/) — the spiritual ancestor: whipped egg yolk + condensed milk over robusta phin coffee
- [Vietnamese Salt Coffee (Cà Phê Muối)](/recipes/vietnamese-salt-coffee/) — Hue specialty with salted whipped foam
- [Vietnamese Coconut Coffee (Cà Phê Dừa)](/recipes/vietnamese-coconut-coffee/) — coconut slushy cloud over phin
- [Greek Coffee & Frappe](/guides/greek-coffee/) — shaken instant-coffee cousin from 1957 Thessaloniki

**Other Asian and tropical coffee:**
- [Thai Iced Coffee (Oliang)](/recipes/thai-iced-coffee/) — spice-blend brew with double-milk float
- [Vietnamese Iced Coffee (Cà Phê Sữa Đá)](/recipes/vietnamese-iced-coffee/) — phin + condensed milk over ice
- [Phin Coffee Guide](/guides/phin-coffee/) — the Vietnamese drip-filter equipment guide

**Iced coffee techniques:**
- [Iced Latte](/recipes/iced-latte/) — the classic milk-and-espresso template
- [Iced Shaken Espresso](/recipes/iced-shaken-espresso/) — Starbucks technique for foamy iced espresso
- [Cold Brew Recipe](/recipes/cold-brew-coffee-recipe/) — the long-soak alternative

**If you want to learn espresso instead:**
- [What Is Espresso?](/guides/what-is-espresso/) — the bedrock shot most coffee drinks build on
- [How to Steam Milk](/guides/milk-steaming-beginners/) — required for cappuccinos, lattes, and flat whites
...
*Related: [Cold Foam](/recipes/cold-foam/) · [Iced Matcha Latte](/recipes/iced-matcha-latte/) · [Espresso Martini](/recipes/espresso-martini/) · [Coffee Frappe](/recipes/coffee-frappe/)*
