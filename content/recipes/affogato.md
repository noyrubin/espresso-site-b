---
title: "What Is an Affogato? The 2-Ingredient Italian Espresso Dessert"
date: 2026-04-06
description: "An affogato is a scoop of vanilla gelato or ice cream 'drowned' in a shot of hot espresso. Learn how to make the perfect affogato at home in under 5 minutes."
tags: ["espresso", "recipe", "dessert", "affogato", "italian"]
categories: ["recipes"]
...
recipe_prep_time: "PT2M"
recipe_cook_time: "PT2M"
recipe_total_time: "PT4M"
recipe_category: "Dessert"
recipe_cuisine: "Italian"
recipe_ingredients:
  - "1-2 shots freshly pulled espresso (about 30-60ml)"
  - "1-2 scoops vanilla gelato or vanilla ice cream"
recipe_instructions:
  - "Scoop 1-2 generous scoops of vanilla gelato into a chilled glass or small bowl."
  - "Pull a fresh double espresso shot directly over the gelato."
  - "Serve immediately before the gelato melts — the contrast of hot and cold is the point."
---
...
| Ingredient | Details |
|-----------|---------|
| Espresso | 1–2 shots (30–60ml), pulled fresh and hot |
| Gelato or ice cream | 1–2 scoops vanilla — gelato preferred, but ice cream works |
| Glass or bowl | Small, chilled if possible |
...
### Grind fresh
Espresso quality starts at the grinder. See our [espresso grind size guide](/guides/espresso-grind-size-guide/) for dial-in guidance.
...
| Dessert | Base | Espresso | Temp | Effort |
|--------|------|----------|------|--------|
| Affogato | Gelato/ice cream | 1–2 shots hot | Hot + cold | Minimal |
| Tiramisu | Ladyfinger + mascarpone | Espresso soak | Cold (chilled) | High |
| Espresso granita | Sweetened espresso, frozen | Is the dessert | Cold | Low |
| Coffee ice cream | Ice cream base | Flavoring | Cold | None |
...
A [moka pot](/guides/moka-pot-vs-espresso-machine/) produces a strong enough brew to work. Use the standard 2:1 ratio and pour over the gelato while hot. A French press or drip coffee will be too weak — the dilution ratio will make the affogato watery. See our full [espresso machine buying guide](/guides/best-espresso-machines-beginners/) if you want to invest in proper espresso.

**What gelato flavor goes best with affogato?**
Vanilla (*fior di latte* or *crema di latte*) is traditional and the safest choice. Hazelnut is a close second. Chocolate gelato can work but competes with the espresso's bitterness. Avoid fruit sorbets — the acid clashes.

**Is affogato served hot or cold?**
Both, simultaneously. The espresso is hot; the gelato is cold. That temperature contrast is the defining feature of the dish. It is meant to be consumed immediately, before the gelato fully melts.

**How much espresso goes in an affogato?**
Traditionally one to two shots — a single (25–30ml) or double (50–60ml). A single shot is lighter and dessert-forward. A double is more coffee-forward and stronger. Neither is wrong. See our [espresso ratio guide](/guides/espresso-ratio-guide/) for shot basics.

**Is affogato a drink or a dessert?**
Both. In Italy, it is often listed on the dessert menu (*dolci*) but ordered after a meal in place of coffee. There is no definitive classification — treat it as whichever you prefer.

**Can I use regular ice cream instead of gelato?**
Yes. Ice cream works fine, though the higher air content means it melts faster and the result is less dense. Use a premium full-fat vanilla ice cream for best results.
