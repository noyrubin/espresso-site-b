---
title: "Iced Shaken Espresso (Starbucks Copycat Recipe)"
date: 2026-04-26
description: "Make a Starbucks Iced Shaken Espresso at home: 2 espresso shots, simple syrup, and ice — shaken hard for 20 seconds, topped with milk. Tall, Grande, and Venti ratios + 6 variations."
tags: ["recipes", "iced", "espresso", "starbucks copycat", "shaken espresso"]
categories: ["recipes"]
...
schema:
  type: Recipe
  name: "Iced Shaken Espresso (Grande Starbucks Copycat)"
  description: "Starbucks-style Iced Shaken Espresso with three espresso shots, classic simple syrup, and a splash of milk — shaken hard with ice to develop foam and chill the espresso instantly."
  prepTime: "PT2M"
  cookTime: "PT1M"
  totalTime: "PT3M"
  recipeYield: "1 Grande (16 oz)"
  recipeIngredient:
    - "3 shots espresso (about 3 oz / 90ml), freshly pulled, hot"
    - "2 tablespoons (1 oz / 30ml) classic simple syrup (1:1 sugar:water)"
    - "1 cup (240ml) ice cubes"
    - "Splash (about 2 oz / 60ml) 2% milk or oat milk"
  recipeInstructions:
    - "Pull 3 shots of espresso (or 3 oz strong moka pot / 6 oz strong cold brew if no espresso machine). Espresso should be fresh and hot — heat is what creates the shaken foam."
    - "Add the hot espresso, simple syrup, and ice to a cocktail shaker. Seal tightly."
    - "Shake hard for 20–30 seconds. The shaker should feel ice-cold and you'll hear the ice break down. The espresso will develop a layer of foam on top."
    - "Strain (or pour through the spout) into a tall 16 oz glass filled with fresh ice."
    - "Top with a splash of milk (about 2 oz). Do not stir — the layered look is part of the drink."
...
- **Classic simple syrup** — Equal parts sugar and water, stirred until dissolved. Stores for a month in the fridge. See [Coffee Syrup Recipes](/guides/coffee-syrup-recipes/) for the full method and 7 flavor variations.
...
1. **Instant chilling** — Hot espresso cooled by violent contact with ice drops 100°F in 20 seconds.
2. **Controlled dilution** — The ice melts just enough to soften the espresso's bitterness without watering it down to nothing.
3. **Foam development** — The agitation aerates the espresso oils, producing a stable layer of brown foam on top — different from crema, but visually similar.
...
Replace classic syrup with [brown sugar syrup](/recipes/brown-sugar-shaken-espresso/) (1:1 brown sugar:water + a pinch of cinnamon). Top with oat milk for the Starbucks Brown Sugar Oatmilk Shaken Espresso copycat — one of their best-selling permanent menu items.

### Vanilla Iced Shaken Espresso

Use [homemade vanilla syrup](/guides/coffee-syrup-recipes/) (1:1 with a split vanilla bean steeped 30 min). Top with vanilla cold foam for a richer drink.
...
Add ¼ teaspoon ground cinnamon to the shaker with the espresso and use [caramel syrup](/recipes/caramel-latte/) instead of classic. Top with cold foam blended with a pinch of cinnamon. Released seasonally; permanent home version.
...
Pour 1 oz of milk over the foam, then top with prepared iced matcha. The cousin of [iced matcha latte](/recipes/iced-matcha-latte/) with the shaken-espresso aromatics layered in.
...
- **AeroPress:** Pull a concentrated AeroPress shot (1:5 ratio, 25g coffee + 125g water). See the [AeroPress guide](/guides/aeropress-guide/).
...
This is one of the highest-caffeine drinks at Starbucks per ounce — 3 shots in 16 oz of mostly espresso. For comparison, a Grande [iced latte](/recipes/iced-latte/) has 150 mg, and a regular iced coffee has about 165 mg.
...
**Too much milk.** A splash. If you want creamy and milky, you want an [iced latte](/recipes/iced-latte/). The shaken espresso is meant to taste like espresso first, milk second.
...
- [Brown Sugar Shaken Espresso](/recipes/brown-sugar-shaken-espresso/) — The Starbucks Brown Sugar Oatmilk Shaken Espresso copycat (the most-ordered shaken variant)
- [Shaken Espresso (Head Term Guide)](/recipes/shaken-espresso/) — All shaken-espresso variations explained
