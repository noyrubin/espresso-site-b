---
title: "Dirty Chai Latte Recipe (Hot & Iced)"
date: 2026-04-09
description: "Make a dirty chai latte at home — chai tea spiced with cardamom, cinnamon, and ginger, combined with a shot of espresso. Hot or iced, better than any coffee shop version."
tags: ["dirty chai", "chai latte", "espresso drinks", "recipes", "spiced coffee"]
categories: ["recipes"]
...
draft: false
schema: "recipe"
recipeName: "Dirty Chai Latte"
recipeCategory: "Coffee"
prepTime: "PT5M"
totalTime: "PT10M"
recipeYield: "1 serving"
recipeIngredient: ["1–2 shots espresso (1–2 oz)", "1 chai tea bag or 2 tablespoons chai concentrate", "3/4 cup milk of choice", "1/2 cup hot water (for tea)", "1–2 teaspoons honey or simple syrup (optional)", "Ground cinnamon for garnish"]
recipeInstructions: ["Brew chai tea: steep 1 chai tea bag in 1/2 cup hot water for 4–5 minutes. Remove bag and sweeten if desired.", "Pull 1–2 shots of espresso.", "Steam or heat 3/4 cup milk until hot and slightly foamy.", "Combine brewed chai tea and steamed milk in a mug.", "Pour espresso over the top or into the chai-milk mixture.", "Garnish with a pinch of cinnamon. Serve immediately."]
---
...
1. **Brew the chai tea.** Boil water and steep 1 chai tea bag in 1/2 cup of hot water for 4–5 minutes. A longer steep = stronger spice flavor. Remove the bag without squeezing (squeezing releases bitter tannins).

2. **Sweeten if desired.** Add 1–2 teaspoons of honey or simple syrup to the hot tea while it's still hot enough to dissolve sweetener.

3. **Pull the espresso.** Brew 1–2 shots (1–2 oz) from your espresso machine. Time this so the espresso and chai are ready around the same time.

4. **Steam the milk.** Heat 3/4 cup of milk to 150°F / 65°C with light foam — not stiff cappuccino foam, but a soft microfoam texture that blends into the drink.

5. **Combine.** Pour the brewed chai into your mug first, then add the steamed milk.

6. **Add the espresso.** Pour the espresso over the top — it will float briefly before blending with the chai and milk below.

7. **Garnish.** A pinch of cinnamon or a cinnamon stick completes the presentation.
...
**Method:**
1. Brew chai tea strong in 1/4 cup hot water, steep 5 minutes, cool to room temperature (or refrigerate ahead of time).
2. Fill a glass with ice.
3. Add cold chai tea + cold milk over the ice.
4. Pour the espresso directly over the ice and milk — it will create a beautiful dark swirl before you stir it.
5. Stir gently, or leave it layered for presentation.
...
See our full [espresso caffeine guide](/guides/espresso-caffeine-guide/) for more detail on espresso caffeine by shot type.
...
Combine iced dirty chai with the brown sugar shaken espresso concept: add 1 tablespoon brown sugar syrup when shaking the espresso. The molasses note pairs surprisingly well with chai's cardamom-cinnamon profile. See our [brown sugar shaken espresso](/recipes/brown-sugar-shaken-espresso/) recipe for the syrup base.
...
**What is a dirty chai latte?**
A dirty chai latte is a regular chai latte (spiced black tea + steamed milk) with one or more shots of espresso added. The "dirty" refers to the addition of espresso to what would otherwise be a clean, espresso-free chai.

**What's the difference between a chai latte and a dirty chai latte?**
A chai latte contains only brewed chai tea and steamed milk — no espresso. A dirty chai latte adds espresso to that combination. The espresso increases caffeine content and adds a coffee flavor dimension that balances against the chai spices.

**Is a dirty chai latte strong?**
Yes — it contains both tea caffeine and espresso caffeine. A single dirty chai has approximately 100–145 mg of caffeine. A double dirty chai can reach 160–220 mg. Both are comparable to a large drip coffee or stronger.

**Can I make a dirty chai without an espresso machine?**
Yes. Use any strong coffee concentrate: AeroPress concentrate (use the inverted method for a stronger extraction), moka pot coffee, or cold brew concentrate. The flavor profile changes slightly but the concept is the same.

**What kind of chai should I use for a dirty chai?**
Any spiced chai tea works: bags, loose leaf, or concentrate. Tazo Chai and Harney & Sons are reliable commercial options. Oregon Chai or Tazo Chai Concentrate are the fastest shortcuts. If you want maximum control over the spice blend, make masala chai from scratch with whole spices and loose black tea.

**Does Starbucks make dirty chai lattes?**
Yes — you can order a "Dirty Chai Latte" at Starbucks by asking for a Chai Tea Latte with one or two shots of espresso added. It's not on the official menu but baristas know the drink. A grande dirty chai typically uses 2 shots.

**Is dirty chai good iced?**
Very good iced. The iced version is arguably more refreshing than the hot version, especially in warmer weather. The cold milk softens the chai spice slightly, making it less intense. Follow the iced dirty chai instructions above.

---

*Explore more espresso drink recipes: [caramel macchiato](/recipes/caramel-macchiato/), [mocha latte](/recipes/mocha/), [cortado](/recipes/cortado/), [iced latte](/recipes/iced-latte/), and [pumpkin spice latte](/recipes/pumpkin-spice-latte/). For the cold version with cold-steep chai concentrate, see the [iced chai latte recipe →](/recipes/iced-chai-latte/).*
