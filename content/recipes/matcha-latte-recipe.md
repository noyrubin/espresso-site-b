---
title: "Matcha Latte Recipe: How to Make the Perfect Cup (Hot & Iced)"
date: 2026-04-11
description: "A foolproof matcha latte recipe — hot or iced — with the exact matcha-to-water ratio, the anti-clump technique, and 5 easy variations. No fancy equipment needed."
tags: ["matcha", "latte", "recipe", "tea", "drinks"]
categories: ["recipes"]
...
draft: false
schema: "recipe"
recipeName: "Matcha Latte Recipe"
recipeCategory: "Beverage"
prepTime: "PT3M"
cookTime: "PT2M"
totalTime: "PT5M"
recipeYield: "1 serving"
recipeIngredient: ["1 teaspoon ceremonial-grade matcha powder (2g)", "2 tablespoons hot water (175°F / 80°C)", "3/4 cup milk of choice (6 oz)", "1-2 teaspoons honey or maple syrup (optional)"]
recipeInstructions: ["Sift the matcha powder into a wide, shallow bowl or mug to break up any clumps.", "Add 2 tablespoons of water heated to 175°F (80°C) — not boiling, which turns matcha bitter.", "Whisk in a rapid W or M motion for 20-30 seconds until a smooth, frothy paste forms with no lumps.", "Steam or heat your milk to around 150°F (65°C). Froth if desired.", "Pour the steamed milk over the matcha paste. Stir gently to combine. Add sweetener to taste."]
---
...
1. Sift 1 tsp matcha into a bowl or mug.
2. Add 2 tablespoons of hot water (175°F) and whisk into a smooth paste.
3. Add sweetener to the warm paste and stir — it dissolves more easily in warm liquid.
4. Fill a glass with ice.
5. Pour ¾ cup cold milk over the ice.
6. Pour the matcha paste over the milk. Stir to combine, or leave layered for presentation.
...
For a deeper dive into the iced version with specific milk temperatures and Japanese café-style techniques, see our [iced matcha latte guide](/recipes/iced-matcha-latte/).
...
**How much matcha goes in a matcha latte?**
Use 1 teaspoon (2 grams) of matcha powder per 8 oz serving. Increase to 1½ teaspoons for a stronger, more intense latte. Decreasing below 1 tsp produces a pale, under-flavored drink.

**What temperature should the water be for a matcha latte?**
175°F (80°C). This is hot enough to dissolve the matcha into a smooth paste but cool enough to preserve its sweetness and avoid extracting bitterness. Never use boiling water (212°F) with matcha.

**Can you make a matcha latte without a whisk?**
Yes. Use a small jar with a tight lid: add matcha and 2 tablespoons of hot water, seal tightly, and shake vigorously for 15 seconds. A regular handheld milk frother also works. A spoon alone is not sufficient — you need aggressive agitation to break up matcha's fine particles.

**What's the difference between a matcha latte and a green tea latte?**
Matcha latte uses ground matcha powder (the whole leaf, stone-ground). Green tea latte typically uses brewed green tea or green tea syrup — both produce a much lighter color and thinner flavor. Matcha is significantly more concentrated, more caffeinated, and has a richer, more complex taste.

**How long does matcha latte last in the fridge?**
The matcha paste can be made ahead and refrigerated for up to 24 hours in a sealed jar. Add milk when ready to drink. A completed matcha latte is best consumed immediately — the matcha will settle and the foam dissipates after 30 minutes.
