---
title: "Vanilla Latte Recipe (Hot & Iced) — Better Than Starbucks"
date: 2026-04-13
description: "How to make a vanilla latte at home — with homemade vanilla syrup, hot and iced versions, and a Starbucks copycat guide. Smooth, sweet, easy."
tags: ["vanilla latte", "latte recipe", "flavored latte", "vanilla coffee"]
categories: ["recipes"]
...
1. Pull 2 shots of espresso (see our [espresso ratio guide](/guides/espresso-ratio-guide/) for extraction tips)
2. Add 1–2 tablespoons of vanilla syrup to your cup
3. Pour the hot espresso over the syrup — stir to combine
4. Steam 6oz of milk to 140–150°F (60–65°C) with a microfoam texture (see [milk steaming guide](/guides/milk-steaming-beginners/))
...
**Why pour espresso last?** The temperature contrast creates a layered effect (like our [iced americano](/recipes/iced-americano/)). The hot espresso melts slightly into the cold milk, and the ice rapidly chills everything without diluting as much as if you cooled the espresso first.
...
| Size | Espresso | Milk | Vanilla Pumps |
|------|---------|------|---------------|
| Tall (12oz) | 1 shot | ~9oz | 3 pumps (~1.5 tbsp syrup) |
| Grande (16oz) | 2 shots | ~11oz | 4 pumps (~2 tbsp syrup) |
| Venti (20oz) | 2 shots | ~14oz | 5 pumps (~2.5 tbsp syrup) |
...
Swap plain vanilla syrup for a brown sugar vanilla syrup: use brown sugar instead of white sugar in the syrup recipe, + vanilla extract. Caramel-toned sweetness, similar to our [brown sugar shaken espresso](/recipes/brown-sugar-shaken-espresso/).

### Iced Vanilla Shaken Espresso
Shake the espresso + vanilla syrup + ice vigorously in a cocktail shaker before pouring over milk. Aeration creates a smoother texture — see our [shaken espresso guide](/recipes/shaken-espresso/).
...
Espresso, steamed milk, and vanilla syrup. The syrup is typically a simple sugar syrup flavored with vanilla extract or vanilla bean. Starbucks uses their house vanilla syrup.

**What is the difference between a latte and a vanilla latte?**
A plain latte is espresso + steamed milk with no added flavoring. A vanilla latte adds vanilla syrup, making it sweeter and flavored. The milk-to-espresso ratio and steaming technique are the same.

**Is a vanilla latte healthy?**
A vanilla latte from Starbucks (Grande, 2% milk) has approximately 250 calories and 35g of sugar. Homemade with lower-sugar syrup and your choice of milk can have significantly fewer calories — a skim milk vanilla latte with 1 tablespoon of homemade syrup runs around 130–150 calories.

**Do vanilla lattes have coffee in them?**
Yes — every latte contains espresso. A Tall vanilla latte has 75mg of caffeine (1 shot), a Grande has 150mg (2 shots). If you want a caffeine-free option, use decaf espresso — the vanilla flavor and steamed milk remain identical.

**Can I make a vanilla latte without an espresso machine?**
Yes. Use strong moka pot coffee (see [how to use a moka pot](/guides/how-to-use-moka-pot/)) or very strong French press coffee as your espresso substitute. The drink won't be identical — you lose the crema — but the vanilla + milk + strong coffee combination is still delicious.
...
- [Brown Sugar Shaken Espresso](/recipes/brown-sugar-shaken-espresso/) — similar sweet espresso drink, cold
- [Vanilla Sweet Cream Cold Brew](/recipes/vanilla-sweet-cream-cold-brew/) — vanilla + cold brew combination
- [Iced Latte Recipe](/recipes/iced-latte/) — base iced latte technique
