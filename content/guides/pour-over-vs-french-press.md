---
title: "Pour Over vs French Press: Which Brew Method Is Better?"
date: 2026-04-21
description: "Pour over coffee is clean and bright with precise control. French press is bold and full-bodied with minimal gear. Here's a full comparison of flavor, technique, cost, and which is right for you."
tags: ["pour over", "french press", "brewing methods", "coffee guide", "manual brewing"]
categories: ["guides"]
...
|---|---|---|
| **Flavor profile** | Clean, bright, complex | Bold, full-bodied, rich |
| **Sediment** | None (paper filter) | Some (metal mesh) |
| **Brew time** | 3–4 minutes | 4 minutes |
| **Active time** | 3–4 min (you pour) | 1 min (then wait) |
| **Equipment cost** | $10–$40 (dripper + kettle) | $15–$60 |
| **Learning curve** | Moderate | Easy |
| **Best for** | Light/medium roasts, single origins | Dark roasts, bold blends |
| **Cleanup** | Easy (toss filter) | More work (grounds to dump) |
...
4. Add grounds — standard [pour over ratio](/guides/pour-over-ratio/) is **1:15 to 1:17** (1g coffee per 15–17g water)
...
3. Add grounds — standard [French press ratio](/guides/french-press-ratio/) is **1:15** (1g coffee per 15g water)
...
| | Pour Over | French Press | Drip Coffee |
|---|---|---|---|
| Hands-on time | High | Low | Minimal |
| Flavor | Clearest | Most body | Balanced |
| Consistency | Variable | High | Very high |
| Volume | 1–4 cups | 2–8 cups | 2–12 cups |
...
For a deeper look at drip coffee, see [What Is Drip Coffee](/guides/what-is-drip-coffee/).
...
Pour over is generally considered healthier because the paper filter removes cafestol — an oil found in unfiltered coffee that raises LDL cholesterol. French press coffee contains cafestol because the metal mesh filter doesn't remove it. The difference is most relevant if you drink multiple cups per day.

**What is the 15 15 15 coffee rule?**
The "15-15-15 rule" is a general guideline for coffee ratios: 15 grams of coffee per 15 ounces of water (approximately 1:28 ratio), brewed at 15 minutes. It's more of a popular mnemonic than a professional standard — most specialty coffee guides recommend 1:15 to 1:17 ratios for pour over and French press.

**Does French press have more caffeine than pour over?**
Both methods extract similar caffeine levels at equivalent ratios. The difference is negligible if you use the same amount of coffee and water. Brew strength matters more than the brewing method for caffeine content.
