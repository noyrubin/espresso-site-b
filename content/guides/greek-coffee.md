---
title: "What Is Greek Coffee? Briki Brewing, Sugar Levels & Greek Frappé Guide"
date: 2026-04-26
description: "Greek coffee is finely ground coffee boiled in a briki and served unfiltered with kaymaki foam. Learn the traditional briki technique, the four sugar levels (sketo to vary glykos), and how to make a Greek frappé."
tags: ["world coffee", "greek coffee", "briki", "frappe", "mediterranean", "specialty"]
categories: ["guides"]
...
schema:
  type: Recipe
  name: "Greek Coffee (Traditional Briki Method)"
  description: "Traditional Greek coffee brewed in a briki (small long-handled pot) using finely ground coffee, water, and optional sugar — boiled slowly to produce a thick foam (kaymaki) on top."
  prepTime: "PT2M"
  cookTime: "PT4M"
  totalTime: "PT6M"
  recipeYield: "1 demitasse (3 oz / 90ml)"
  recipeIngredient:
    - "1 heaping teaspoon Greek coffee (very finely ground, finer than espresso)"
    - "1 demitasse cup (approx. 3 oz / 90ml) cold water"
    - "Sugar to taste (0–2 tsp depending on style — see sugar levels below)"
  recipeInstructions:
    - "Measure cold water using the demitasse cup you'll serve in (one cup of water per cup of coffee). Pour into the briki."
    - "Add the coffee and sugar (if using). Do not stir yet."
    - "Place the briki over low heat. As the coffee warms, stir gently once or twice to dissolve the sugar and combine."
    - "Watch closely. As the coffee approaches a boil, a thick brown foam (kaymaki) will rise toward the rim — this takes 3–4 minutes on low heat."
    - "The moment the foam reaches the top of the briki (just before it spills), remove from heat immediately. Do not let it boil over."
    - "Pour gently down the side of the demitasse cup so the kaymaki transfers intact to the top of the cup."
    - "Let it sit 30–60 seconds before drinking so the grounds settle. Sip slowly — never drink the bottom layer of grounds."
---
...
**Method:**
1. Add instant coffee, sugar, and 1 tablespoon of cold water to a cocktail shaker (or use a handheld milk frother in a tall glass).
2. Shake hard for 30 seconds — or whip with the frother for 30 seconds. The mixture should triple in volume into a thick, stable, light-brown foam.
3. Fill a tall glass with ice cubes.
4. Pour the foam over the ice, then top with cold water.
5. Add a splash of evaporated milk if desired (this is the *me gala* version).
6. Serve with a straw — the foam should hold for an hour.
