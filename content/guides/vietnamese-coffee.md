---
title: "Vietnamese Coffee: The Complete Guide (Phin, Condensed Milk, and All Styles)"
date: 2026-04-15
description: "Vietnamese coffee uses robusta beans, a phin filter, and sweetened condensed milk to create an intensely strong, sweet cup. Here's everything: the phin, hot and iced methods, egg coffee, and more."
tags: ["vietnamese coffee", "ca phe sua da", "phin filter", "condensed milk coffee", "espresso drinks"]
categories: ["guides"]
...
| | Vietnamese Coffee | Espresso | Drip Coffee |
|---|---|---|---|
| **Beans** | Robusta (mostly) | Arabica (mostly) | Arabica (mostly) |
| **Caffeine** | Very high (~150–200mg/cup) | High (~70mg/shot) | Moderate (~90mg/cup) |
| **Brewing method** | Slow phin drip (4–6 min) | Pressure extraction (25–35 sec) | Paper filter drip |
| **Sweetener** | Condensed milk (traditional) | Optional syrup/sugar | Optional |
| **Strength** | Very strong, almost syrupy | Concentrated, complex | Variable |
| **Body** | Heavy, slightly gritty | Thick, with crema | Light to medium |
...
See our dedicated [Vietnamese Iced Coffee recipe](/recipes/vietnamese-iced-coffee/) for the full step-by-step with variations.
...
**Moka pot:** The concentrated moka pot output (see our [moka pot guide](/guides/how-to-use-moka-pot/)) works as a Vietnamese coffee base. The flavor is slightly different (more metallic, more acidic) but the ratio of strong coffee to condensed milk is the same.
...
|---|---|---|
| **Pressure** | None (gravity drip) | 9 bars |
| **Brew time** | 4–6 minutes | 25–35 seconds |
| **Grind** | Medium-coarse | Very fine |
| **Crema** | None | Present |
| **Caffeine** | Very high (robusta) | High (arabica) |
| **Sweetener** | Condensed milk (traditional) | Optional |
| **Flavor** | Earthy, bitter, sweet from milk | Fruity, complex, bitter |
