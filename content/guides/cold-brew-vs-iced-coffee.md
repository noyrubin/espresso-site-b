...
date: 2026-04-13
description: "Cold brew vs iced coffee — side-by-side comparison of flavor, strength, caffeine, acidity, cost, and how to make both at home. Clear, no-fluff guide."
tags: ["cold brew", "iced coffee", "cold coffee", "coffee comparison"]
categories: ["guides"]
...
Cold brew is typically made at a 1:4 or 1:5 coffee-to-water ratio (grounds:water) and then diluted to taste when serving. See our [cold brew ratio guide](/guides/cold-brew-ratio/) for exact measurements.
...
The fastest method:
1. Brew a strong batch of coffee (use double the coffee grounds to compensate for ice dilution)
...
1. Weigh out your ice — use it as part of your total water weight (typically 40% ice, 60% hot water)
2. Brew pour over onto the ice using your [coffee-to-water ratio](/guides/coffee-to-water-ratio/)
3. The coffee chills instantly without diluting excessively
...
**Step-by-step:**
1. Grind coffee coarsely (like coarse sea salt) — use a 1:4 coffee-to-water ratio
2. Combine grounds and cold filtered water in a jar or pitcher
3. Stir gently to make sure all grounds are wet
4. Cover and refrigerate (or leave at room temperature) for 12–24 hours
   - 12 hours → lighter, more delicate
   - 18 hours → balanced, recommended
   - 24 hours → strongest, most intense
5. Strain through a fine-mesh strainer lined with cheesecloth or a coffee filter
6. Store in the refrigerator — keeps for up to 2 weeks
7. Serve over ice, diluted 1:1 with water or milk

For the full recipe and ratio guide, see our [cold brew coffee recipe](/recipes/cold-brew-coffee-recipe/).
...
**The quick method:**
1. Brew coffee double-strength (use 2x your normal coffee grounds)
2. Let it cool slightly (5–10 minutes)
3. Pour over a glass full of ice
4. Add milk, sweetener, or flavored syrup as desired

**Flash brew method (better flavor):**
1. Prepare your pour over or drip setup
2. Put ice in the carafe (about 40% of total liquid weight)
3. Use 60% of your normal water amount in the kettle
4. Brew the hot coffee directly onto the ice
5. The coffee chills instantly and dilution is controlled
...
- Use an espresso machine to brew a double shot and pour it over ice (a [classic iced americano](/recipes/iced-americano/))
- Make "Japanese iced espresso" by pulling a shot over ice directly
- Use our [vanilla sweet cream cold brew](/recipes/vanilla-sweet-cream-cold-brew/) recipe which combines cold brew concentrate with sweet cream topping

---

## Cold Brew vs Iced Coffee: Cost Comparison

**Cold brew (homemade):** Approximately $0.50–$1.50 per 12oz serving depending on your coffee
**Iced coffee (homemade):** Approximately $0.25–$1.00 per 12oz serving
**Cold brew (coffee shop):** $4–$7 per serving
**Iced coffee (coffee shop):** $3–$6 per serving
...
Cold brew concentrate is much stronger. Ready-to-drink cold brew (properly diluted) has similar caffeine to iced coffee — roughly 100–150mg per 8oz serving.

**What is healthier, iced coffee or cold brew?**
Cold brew is lower in acid (pH ~6.3 vs ~5.0 for iced coffee), which makes it easier on sensitive stomachs. Both have similar calorie counts when consumed black. Cold brew is slightly easier to drink without added sugar because the low-acid extraction tastes naturally smooth.

**Is cold brew better for people with GERD?**
Generally yes — cold brew's lower acidity is gentler on the esophagus. Many GERD sufferers who can't tolerate hot coffee or iced coffee can drink cold brew without discomfort.

**What are the disadvantages of cold brew?**
Planning time (12–24 hour steep), slightly more coffee grounds per serving than iced coffee, and the flavor profile is less bright/complex — light roast enthusiasts often prefer flash-brewed iced coffee.

**Can I make iced coffee from cold brew?**
Yes — cold brew is a form of iced coffee. When people say "iced coffee" vs "cold brew" they typically mean the specific styles described here, but technically cold brew served over ice is iced coffee.
...
- [Iced Coffee Recipe](/recipes/iced-coffee-recipe/) — 4 methods including flash brew
...
- [Japanese Iced Coffee (Flash Brew)](/recipes/japanese-iced-coffee/) — the third iced coffee method: hot pour-over directly over ice — brighter than cold brew, faster than overnight steeping
