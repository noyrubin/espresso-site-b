---
title: "What Is Café de Olla? Traditional Mexican Spiced Coffee Recipe"
date: 2026-04-26
description: "Café de olla is Mexican coffee brewed with piloncillo, cinnamon, and spices. Learn the traditional recipe, 4 home brewing methods, and an espresso-based modern adaptation."
tags: ["world coffee", "recipes", "spiced coffee", "mexican coffee", "cafe de olla"]
categories: ["guides"]
...
schema:
  type: Recipe
  name: "Café de Olla (Traditional Mexican Spiced Coffee)"
  description: "Traditional Mexican coffee brewed with piloncillo (raw cane sugar), canela (Mexican cinnamon), and optional spices — simmered slowly in a clay pot or regular saucepan until fragrant and naturally sweet."
  prepTime: "PT5M"
  cookTime: "PT10M"
  totalTime: "PT15M"
  recipeYield: "2 servings (about 12 oz total)"
  recipeIngredient:
    - "2 tbsp medium-dark ground coffee (coarse grind, like French press)"
    - "2 oz piloncillo (or 3 tbsp dark brown sugar, packed)"
    - "1 cinnamon stick (canela — Mexican/Ceylon cinnamon preferred)"
    - "2.5 cups (600ml) water"
    - "Optional: 2 whole cloves, 1 star anise, small strip orange peel"
  recipeInstructions:
    - step: "Combine water and piloncillo in a small saucepan or clay pot. Bring to a low boil over medium heat, stirring until piloncillo fully dissolves — about 3 minutes."
    - step: "Add the cinnamon stick and any optional spices (cloves, anise, orange peel). Reduce heat to low and simmer for 3 minutes to bloom the spices."
    - step: "Add the ground coffee. Stir once to submerge, then simmer on low for 4 minutes. Do not boil aggressively — a gentle simmer keeps the flavors clean."
    - step: "Remove from heat. Let steep for 2 more minutes undisturbed."
    - step: "Strain through a fine mesh strainer into cups. Serve hot. Enjoy immediately — café de olla doesn't keep well once brewed."
---
...
**What is Café de Olla made of?**
Café de olla is made with coarsely ground coffee, piloncillo (raw Mexican cane sugar), and canela (Mexican cinnamon), all simmered together in water — traditionally in a clay pot. Optional additions include cloves, star anise, and orange peel.

**What is the difference between coffee and Café de Olla?**
...
**Why do they call it Café de Olla?**
...
**Is Café de Olla the same as Mexican coffee?**
Café de olla is a specific type of Mexican coffee. "Mexican coffee" can refer broadly to any coffee from Mexico (known for its Veracruz, Chiapas, and Oaxacan beans) — or informally to café de olla-style spiced coffee. When someone at a restaurant offers "Mexican coffee," they typically mean café de olla or a variation.

---

## Related Guides

- [What Is Café Cubano?](/recipes/cafe-cubano/) — Cuban espresso with espumita
- [What Is Café con Leche?](/guides/cafe-con-leche/) — Spanish coffee with steamed milk
...
- [Yemeni Coffee (Qahwa Yemenia & Qishr)](/guides/yemeni-coffee/) — Coffee's birthplace, with the original Mocha port story
